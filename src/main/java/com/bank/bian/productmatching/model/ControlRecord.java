package com.bank.bian.productmatching.model;
...
/**
 * The BIAN control record for this service domain: "Product Match Procedure".
 *
 ...
 * to its asset type (Product Match). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Product Match Procedure";
